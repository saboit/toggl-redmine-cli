...
const defaultTogglProjects = [
  { id: 999, name: "#12345 Fix auth bug ProjectName" },
];
...
export const mockRedmineCreateIssue = (
  issue = { id: 5001, subject: "[PROJ-123] Fix authentication bug" },
) =>
